...
# 📖  Weather: React  <a name="Weather"></a>

**Weather** is a setup of React, add the logic of the Weathers, (redux action, reducers, and store), add style and Get Data from API.
...
-  This project get weather data from.
-  This Project use React route.
-  This Project use Redux Toolkit. 
-  This Project add unit testing. 
...
```sh
 cd my-folder
 git clone git@github.com:AliShahSafdari/weather.git
```
### Install
...
- [Air Pollution API](https://openweathermap.org/current#one)
